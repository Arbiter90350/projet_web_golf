  ...
  return (
    <div style={{ position: 'relative' }}>
      <div
        ...
        dangerouslySetInnerHTML={{ __html: toSafeHtml(internalHtml) }}
      />
      ...
      {showToolbar && (
        <div style={{ ...TOOLBAR_STYLE, top: toolbarPos.top, left: toolbarPos.left }} onMouseDown={(e) => e.preventDefault()}>
          <button type="button" style={BUTTON_STYLE} title="Gras" onClick={() => applyCommand('bold')}>B</button>
          <button type="button" style={BUTTON_STYLE} title="Italique" onClick={() => applyCommand('italic')}><i>I</i></button>
          <button type="button" style={BUTTON_STYLE} title="Souligné" onClick={() => applyCommand('underline')}><u>U</u></button>
          <button type="button" style={BUTTON_STYLE} title="Titre 1" onClick={() => applyCommand('formatBlock', 'H1')}>H1</button>
          <button type="button" style={BUTTON_STYLE} title="Titre 2" onClick={() => applyCommand('formatBlock', 'H2')}>H2</button>
          <button type="button" style={BUTTON_STYLE} title="Titre 3" onClick={() => applyCommand('formatBlock', 'H3')}>H3</button>
          <button type="button" style={BUTTON_STYLE} title="Effacer la mise en forme" onClick={() => applyCommand('removeFormat')}>↺</button>
        </div>
      )}
    </div>
  );
